...
dimension=[2 3 5 7 10 13 19];%p2
algo_name=['epcs ';'ibea ';'msops';'spea2';'hype ';'dm1  ';'moead'];%i3

fid = fopen('wfg123456789.txt', 'w');
...
a=strcat(problem_name(i1,:),'_',algo_name(i3,:),'_',num2str(dim),'.txt');% a = dtlz1_epcs_2.txt
