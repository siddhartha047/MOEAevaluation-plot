...
RefDir = 'E:\Thesis lab experiment Documents\pf\RefMx300\moeawfg\';
...
%genDirectory='gen\';
%genDirectory='E:\Thesis lab experiment Documents\sidCleanJmetal\jmetal\abcGenerations\MOEAD\';
%genDirectory='E:\Thesis lab experiment documents\Results\abcGenerations\WfgRerun\nsgaiii\';
genDirectory='E:\Thesis lab experiment documents\abcgenerations\sbx30\';
baseDirectory='E:\Thesis lab experiment Documents\abcGenerations\100\';
...
for i1=2:9
  ...
  %  disp(sidn);
    ...
    disp(hyp2/hyp1);
                ...
                samplingPoints=100000;
                
                
                
                
                %hvr=sid_approximate_hypervolume_ms(Ref',P1',ub,samplingPoints);
                hvr=approximate_hypervolume_ms(P1',ub,samplingPoints);
