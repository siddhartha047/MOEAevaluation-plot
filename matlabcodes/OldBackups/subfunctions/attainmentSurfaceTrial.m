function f=attainmentSurfaceTrial()
    ...
    %genDir='E:\Thesis lab experiment documents\abcgenerations\perfectWFG-DTLZ\Analysis\estimatingbestK\3\050g\2'
    ...
    genDir=getmedianresult(strcat(genDir,'\sid',type,num2str(i),'3.txt'),basedon)
    nsgadir=getmedianresult(strcat(nsgadir,'\nsgaiii',type,num2str(i),'3.txt'),basedon)
    %nsgadir=getmedianresult(strcat(nsgadir,'\nsgaiiiexp',type,num2str(i),'3.txt'),basedon)
    hypedir=getmedianresult(strcat(hypedir,'\hype',type,num2str(i),'3.txt'),basedon)    
    moeaddir=getmedianresult(strcat(moeaddir,'\moead',type,num2str(i),'3.txt'),basedon)
    gde3dir=getmedianresult(strcat(gde3dir,'\gde3',type,num2str(i),'3.txt'),basedon)
    zhenandir=getmedianresult(strcat(zhenandir,'\zhenan',type,num2str(i),'3.txt'),basedon)
