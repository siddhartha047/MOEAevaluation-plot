...
dirName='D:\FDEA2016\Codes\abcgenerations\recompileWFG-DTLZ\perfectPICEAG\';
...
%seed=[0.70, 0.75, 0.80, 0.85 ,0.9,0.95,1]
...
testNo = sidTestNo; objvNo = dimNNNN(dimno); N = populationSize(dimno); Ngoal = objvNo*100; maxGen = 250;
