function f=FDEAparameterEvaluationDTLZ()
...
for param=[8]
 ...
 genDirectory=strcat('D:\FDEA2016\Codes\abcgenerations\recompileWFG-DTLZ\FDEA\FDEAdtlzgaussian\gaussian\','\',num2str(param),'g\');
...
for i1=2:2
    for i2= 5:5
        ...
        writefileName=strcat(genDirectory,'hvigd/',algo_name(1,:),problem_name(i1,:), num2str(dimension(i2)),'.txt');
