function f=preferredReferencePoint()
   ...
   count=1;
    ...
    for i=2:m             
        ...
        elseif sol(1,1)==-1 && sol(1,2)==-1 
            ...
            scatter(xp,yp,[],mcolor,marker,'filled','MarkerEdgeColor',[0 0 0],'MarkerFaceColor',ran);                                    
            scatter(c(1:1,1),c(1:1,2),[],ccolor,'d','filled','MarkerEdgeColor',[0 0 0]);                        
