function f=FDEAparameterEvaluation()
...
for param=[2 3 4 5 6 7]

 genDirectory=strcat('D:\FDEA2016\Codes\abcgenerations\recompileWFG-DTLZ\Analysis\parameterSensitivity\',num2str(paramdim),'\',num2str(param),'g\');
